    ...
    <div className="text-dark-600">
      ...
      <div className="grid lg:grid-cols-2 mt-10">
        <form action="">
          ...
          <Input
            label="Website"
            helperText="For example, https://knownorigin.io"
          />
          <Input
            label="Twitter handle"
            helperText="For example, KnownOrigin_io"
          />
          <Input
            label="Instagram name"
            helperText="For example, KnownOrigin.io
"
          />
          <Input label="Location" />
          <div className="flex items-center justify-between">
            <button className="py-2 px-6 rounded-md bg-blue-500 text-white">
              Save profile
            </button>
            <button className="py-2 px-6 rounded-md border border-gray-400  ">
              Cancel
            </button>
          </div>
        </form>
